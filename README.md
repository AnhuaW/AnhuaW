...
I recently graduated with a Master's degree in Human-Computer Interaction from the University of Michigan School of Information, where my work focused on AR/VR, interactive systems, and user-centered design.

I'm experienced in designing, building, and evaluating interactive systems that connect human-centered design, immersive technology, and real-world use.

## What I Do
- 🥽 AR/VR research and development 
- 🎮 Game development 
...
## Skills
**Languages:** C#, C++, C, Python, Java, JavaScript, TypeScript, HTML/CSS, R  
**Web:** React, Next.js, Three.js, Django, Flask, Spring Boot, REST APIs, SQLite, PosgreSQL
**XR / Game Dev:** Unity, Meta Quest development, Oculus Interaction SDK, Vuforia, WebXR  
**Tools:** Git, GitHub, VS Code, Visual Studio, FMOD, Wwise
